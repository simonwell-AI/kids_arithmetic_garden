...
export default function GardenPage() {
  ...
  const SEED_IDS = ["pink_flower", "sun_flower", "tomato", "rose", "brocoli", "tulip", "Lavender", "daffodils", "peach", "grape"];
          ...
          <div className="flex flex-col items-center gap-5 rounded-3xl border-2 border-green-200 bg-white/90 p-6 shadow-lg">
            ...
            {plantingSeedId ? (
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {["pink_flower", "sun_flower", "tomato", "rose", "brocoli", "tulip", "Lavender", "daffodils", "peach", "grape"].map((seedId) => (
                  <button
                    key={seedId}
                    type="button"
