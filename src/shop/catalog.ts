...
export const SHOP_CATALOG: ShopItem[] = [
  ...
  { id: "seed_grape", type: "seed", name: "葡萄種子", price: 30, seedId: "grape" },
  { id: "seed_orchid", type: "seed", name: "蘭花種子", price: 32, seedId: "orchid" },
  { id: "seed_cactus", type: "seed", name: "仙人掌種子", price: 30, seedId: "cactus" },
  { id: "seed_strawberry", type: "seed", name: "草莓種子", price: 40, seedId: "strawberry" },
  { id: "seed_blueberry", type: "seed", name: "藍莓種子", price: 44, seedId: "blueberry" },
  { id: "seed_tangerine", type: "seed", name: "橘子種子", price: 42, seedId: "tangerine" },
  ...
  { id: "tool_insect_clips", type: "insect_tool", name: "昆蟲夾子", price: 6, toolId: "insect_clips", toolImagePath: `${INSECT_ASSETS_BASE}/insect_clips.png` },
